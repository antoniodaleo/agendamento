...
<head>
    ...
    <title>Eu amo Italiano | Admin | <?php echo $this->renderSection('title'); ?></title>
    ...
    <!-- CSS especifico da view que estende esse template -->
...
<body id="page-top">
    ...
    <!-- JS especifico da view que estende esse template -->

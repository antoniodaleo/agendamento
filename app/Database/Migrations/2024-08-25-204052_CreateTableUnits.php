        ...
        $this->forge->addField([
            ...
            'starttime' => [
                ...
                'comment' => 'Horário em que a unidade inicia o expediente. Esse valor é usado para calcular e exibir os horários
                            disponives da unidade. Exemplo: 08:00' 
            ],
            'endtime' => [
                'type' => 'VARCHAR', 
                'constraint' => 6, 
                'comment' => 'Horário em que a unidade finaliza o expediente. Esse valor é usado para calcular e exibir os horários
                            disponives da unidade. Exemplo: 18:00' 
            ],
            'servicetime' => [
                'type' => 'VARCHAR', 
                'constraint' => 20, 
                'comment' => 'Tempo necessario para cada atendimento. Exemplo: 1 hour, 10 minutes, 2 hours, ' 
            ],
